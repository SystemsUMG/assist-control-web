        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col">
                            <h6>Tabla de Profesores</h6>
                        </div>
                        <div class="col text-end">
                            <button type="button" @click="OPEN('POST')" class="btn btn-dark btn-sm mb-3">Crear Profesor</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr v-for="teacher in teachers" :key="teacher.id">
                                <td>
                                    <div class="px-3">
                                        <span class="text-secondary text-xs font-weight-bold">{{ teacher.name + ' ' + teacher.last_name }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="px-3">
                                ...
                                <td>
                                    <div class="px-3">
                                        <span class="badge bg-primary" v-if="teacher.active == '1'">Activo</span>
                                        <span class="badge bg-danger" v-else>Inactivo</span>
                                    </div>
                                </td>
                                <td class="align-middle">
                                    <a  class="text-success font-weight-bold text-xs cursor-pointer"  @click="OPEN('PUT', teacher.id)">Editar</a>
                                    &nbsp;
                                    <a class="text-danger font-weight-bold text-xs cursor-pointer" @click="OPEN('DELETE', teacher.id)">Eliminar</a>
                                </td>
                            </tr>
                            </tbody>
                            <tbody v-else>
