            ...
            <div class="modal-content">
                <form @submit.prevent="SEND()">
                    ...
                    <div class="modal-body pt-0 px-4">
                        ...
                        <p class="text-uppercase text-sm">Información del Centro</p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="form-control-label">Nombre del Centro</label>
    ...
    methods:{
        ...
        SEND: function(){
            ...
            if(_this.count == 1){
                ...
                this.errors = []
                setTimeout(function() {
                    axios({url: '/centers' + method, method: 'POST', data: form })
                        .then((resp) => {
                            if(resp.data.result) {
                                _this.icon = 'success'
                                _this.message = resp.data.message
